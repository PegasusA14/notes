...
export const NoteEditorModal = ({ noteToEdit, onClose }: NoteEditorModalProps) => {
    ...
    return (
        <Dialog open={isNoteEditorOpen} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-2xl">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4 pt-4">
                    <Input
                        ...
                        className="text-xl font-bold border-0 bg-zinc-50 focus-visible:ring-1 shadow-none px-4 py-3 h-auto"
                    />
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-zinc-100">
                        ...
                        <div className="flex space-x-3">
                            ...
                            <Button type="submit" disabled={isPending} className="px-6 rounded-full shadow-sm hover:shadow-md transition-shadow">
